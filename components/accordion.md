...
<div class="box-secondary mb-24">
  <div class="box p-10 sm:p-15 md:p-16 lg:p-24 box-link pt-20 pb-20" accordion="#accordion-example">
    Click this box to see an example of the accordion transitions.
  </div>
  <div id="accordion-example" class="accordion accordion-xs accordion-closed p-10 sm:p-15 md:p-16 lg:p-24 rounded-bottom">
