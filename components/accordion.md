...
<div class="box-secondary mb-24">
  <div class="box p-8 sm:p-16 md:p-16 lg:p-24 box-link pt-24 pb-24" accordion="#accordion-example">
    Click this box to see an example of the accordion transitions.
  </div>
  <div id="accordion-example" class="accordion accordion-xs accordion-closed p-8 sm:p-16 md:p-16 lg:p-24 rounded-bottom">
