...
{% for color in page.primary_colors %}
  <ul class="col-container shade-list mb-24" shade-list>
    {% for shade in page.shades %}
      <li class="col col-50 sm:col-25 md:col-0 pl-5 pr-5 sm:pl-10 sm:pr-10 mb-8 sm:mb-16 shade-item shade-{{ shade | downcase }} shade-{{ color | color_css_class: shade }}">
...
<ul class="col-container shade-list mb-24" shade-list>
  ...
  {% for color in page.base_colors %}
    <li class="col pl-5 pr-5 sm:pl-10 sm:pr-10 mb-8 sm:mb-16 shade-item shade-{{ shade | downcase }} shade-{{ color | color_css_class: shade }}">
      <div class="shade-box box bg-{{ color | color_css_class: shade }} shade-{{ shade | downcase | replace: 'er', '' | replace: 'est', '' }}">
        <div class="shade-color col-center text-xxl bold bg-{{ color | color_css_class: shade }}" shade-color></div>
        <p class="shade-text text-sm medium {{ color | color_css_class: shade }}">
...
<div class="col-container">
  <div class="col">
    <h3>Text Shades</h3>
    <div class="box p-10 sm:p-15 md:p-16 lg:p-24 mt-10">
  ...
  <div class="col">
    ...
    <div class="box-secondary p-10 sm:p-15 md:p-16 lg:p-24 bg-gray-dark mt-10">
      <ul class="list medium">
